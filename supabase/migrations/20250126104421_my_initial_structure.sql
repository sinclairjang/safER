...
CREATE OR REPLACE FUNCTION public.find_nearby_hospitals(user_lat double precision, user_lon double precision, radius_km double precision, availability_units text[], equip_list text[] DEFAULT NULL::text[])
 RETURNS json
 LANGUAGE plpgsql
AS $function$DECLARE
  dynamic_cond text := '';
