...
CREATE TABLE IF NOT EXISTS "public"."hospital_bed_operation_rate" (
    "hpid" "text" NOT NULL,
    "hvec_rate" integer,
    "hvoc_rate" integer,
    "hvcc_rate" integer,
...
ALTER TABLE "public"."hospital_bed_operation_rate" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."hospital_bed_operation_rate"
    ADD CONSTRAINT "hospital_bed_availability_rate_pkey" PRIMARY KEY ("hpid");
...
ALTER TABLE ONLY "public"."hospital_bed_operation_rate"
    ADD CONSTRAINT "hospital_bed_availability_rate_fkey" FOREIGN KEY ("hpid") REFERENCES "public"."hospitals"("hpid") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "allow all access to chanho" ON "public"."hospital_bed_availability" TO "chanho" USING (true);



CREATE POLICY "allow all access to chanho" ON "public"."hospital_bed_operation_rate" TO "chanho" USING (true);
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."hospital_bed_availability" TO "chanho";



GRANT ALL ON TABLE "public"."hospital_bed_operation_rate" TO "anon";
GRANT ALL ON TABLE "public"."hospital_bed_operation_rate" TO "authenticated";
GRANT ALL ON TABLE "public"."hospital_bed_operation_rate" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."hospital_bed_operation_rate" TO "chanho";
